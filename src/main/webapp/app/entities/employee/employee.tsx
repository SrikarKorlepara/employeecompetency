  ...
  return (
    <div>
      <h2 id="employee-heading" data-cy="EmployeeHeading">
        <Translate contentKey="employeeinfoApp.employee.home.title">Employees</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="employeeinfoApp.employee.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/employee/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="employeeinfoApp.employee.home.createLabel">Create new Employee</Translate>
          </Link>
        </div>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="employeeinfoApp.employee.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('dateOfJoining')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('dateOfJoining')} />
                </th>
                ...
                <th>
                  <Translate contentKey="employeeinfoApp.employee.department">Department</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {employeeList.map((employee, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`employeeinfoApp.EmployeePosition.${employee.position}`} />
                  </td>
                  <td>
                    {employee.dateOfJoining ? (
                      <TextFormat type="date" value={employee.dateOfJoining} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    <Translate contentKey={`employeeinfoApp.EmployeeStatus.${employee.status}`} />
                  </td>
                  <td>
                    {employee.department ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="employeeinfoApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        )}
      </div>
