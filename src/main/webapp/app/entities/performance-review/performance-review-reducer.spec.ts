...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './performance-review.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERFORMANCEREVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERFORMANCEREVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERFORMANCEREVIEW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PERFORMANCEREVIEW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PERFORMANCEREVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERFORMANCEREVIEW actions', async () => {
      const arg = 42666;
