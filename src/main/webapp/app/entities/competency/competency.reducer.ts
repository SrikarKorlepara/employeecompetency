...
export const getEntities = createAsyncThunk('competency/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
  const requestUrl = `${apiUrl}?${sort ? `page=${page}&size=${size}&sort=${sort}&` : ''}cacheBuster=${new Date().getTime()}`;
  return axios.get<ICompetency[]>(requestUrl);
});

export const getEntity = createAsyncThunk(
  'competency/fetch_entity',
...
export const createEntity = createAsyncThunk(
  'competency/create_entity',
  async (entity: ICompetency, thunkAPI) => {
...
export const updateEntity = createAsyncThunk(
  'competency/update_entity',
  async (entity: ICompetency, thunkAPI) => {
    const result = await axios.put<ICompetency>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  'competency/partial_update_entity',
  async (entity: ICompetency, thunkAPI) => {
    const result = await axios.patch<ICompetency>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
