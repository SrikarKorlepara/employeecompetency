...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="employeeinfoApp.department.delete.question">
        <Translate contentKey="employeeinfoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
