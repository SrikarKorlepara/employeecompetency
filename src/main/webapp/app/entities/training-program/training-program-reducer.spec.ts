...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAININGPROGRAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAININGPROGRAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAININGPROGRAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRAININGPROGRAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRAININGPROGRAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRAININGPROGRAM actions', async () => {
      const arg = 42666;
