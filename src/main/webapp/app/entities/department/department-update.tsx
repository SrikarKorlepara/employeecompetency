...
export const DepartmentUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    if (values.departmentId !== undefined && typeof values.departmentId !== 'number') {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="employeeinfoApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="employeeinfoApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('employeeinfoApp.department.departmentId')}
              ...
              />
              <ValidatedField
                label={translate('employeeinfoApp.department.departmentName')}
