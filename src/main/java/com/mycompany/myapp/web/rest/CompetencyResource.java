...
import com.mycompany.myapp.service.CompetencyQueryService;
import com.mycompany.myapp.service.CompetencyService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Competency}.
 */
@RestController
...
public class CompetencyResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<CompetencyDTO> createCompetency(@RequestBody CompetencyDTO competencyDTO) throws URISyntaxException {
        ...
        competencyDTO = competencyService.save(competencyDTO);
        return ResponseEntity.created(new URI("/api/competencies/" + competencyDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, competencyDTO.getId().toString()))
            .body(competencyDTO);
    }
    ...
    public ResponseEntity<CompetencyDTO> updateCompetency(
        ...
        competencyDTO = competencyService.update(competencyDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<CompetencyDTO> getCompetency(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCompetency(@PathVariable("id") Long id) {
