...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETENCY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETENCY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETENCY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMPETENCY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETENCY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETENCY actions', async () => {
      const arg = 42666;
