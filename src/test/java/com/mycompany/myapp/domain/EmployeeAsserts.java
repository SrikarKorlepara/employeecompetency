...
public class EmployeeAsserts {
    ...
    public static void assertEmployeeUpdatableFieldsEquals(Employee expected, Employee actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getDateOfJoining()).as("check dateOfJoining").isEqualTo(actual.getDateOfJoining()))
    ...
    public static void assertEmployeeUpdatableRelationshipsEquals(Employee expected, Employee actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getSkillSets()).as("check skillSets").isEqualTo(actual.getSkillSets()))
            .satisfies(e -> assertThat(e.getCompetencies()).as("check competencies").isEqualTo(actual.getCompetencies()))
