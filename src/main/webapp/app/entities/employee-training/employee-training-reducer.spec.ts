...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './employee-training.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEETRAINING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPLOYEETRAINING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPLOYEETRAINING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EMPLOYEETRAINING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEETRAINING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPLOYEETRAINING actions', async () => {
      const arg = 42666;
