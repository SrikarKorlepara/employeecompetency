...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './skill-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SKILLSET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SKILLSET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SKILLSET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SKILLSET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SKILLSET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SKILLSET actions', async () => {
      const arg = 42666;
